                ...
                <Table>
                    ...
                    <TableBody>
                      {attendance.map((attendance: any) =>(
                        ...
                        <TableCell className="text-center"><Button variant="secondary" className="w-[60] h-[15] bg-red-900" onClick={() => timeOutie(attendance.id)}><ico.Clock/>Time Out</Button></TableCell>
                        </TableRow>
                      ))}
                    </TableBody>
                </Table>
